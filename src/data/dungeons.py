...
DUNGEONS = {
    ...
    "3": {
        ...
        "mobs": [
            ("Горный тролль", 800, False),
            ("Орк-надзиратель", 1000, False),
            ("Верховный Орк (БОСС)", 2500, True),
        ],
        "min_dmg": 70,
        "max_dmg": 120,
    ...
    "4": {
        ...
        "mobs": [
            ("Теневой солдат", 2000, False),
            ("Теневой Командир (БОСС)", 6000, True),
        ],
        "min_dmg": 200,
        "max_dmg": 350,
    ...
    "5": {
        ...
        "mobs": [
            ("Высший орк", 6000, False),
            ("Повелитель Пламени (БОСС)", 20000, True),
        ],
        "min_dmg": 500,
        "max_dmg": 900,
    ...
    "6": {
        ...
        "mobs": [
            ("Мутант-муравей", 50000, False),
            ("Король Муравьев (БОСС)", 100000, True),
        ],
        "min_dmg": 1000,
        "max_dmg": 2000,
